//This is an example of using Red Pitaya with the Red Pitaya Click Shield and DC MOTOR 2 Click Board. This example runs a dc motor at diffrent speeds and directions.
