//This is an example of using Red Pitaya with the Red Pitaya Click Shield and Button G Click Board. This example turns on the led on the red pitaya board when the button G is pressed
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
