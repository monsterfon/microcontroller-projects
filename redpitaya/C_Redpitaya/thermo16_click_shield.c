//This is an example of using Red Pitaya with the Red Pitaya Click Shield and Thermo 16 Click Board. This example measures the temperature inside the sensor and outputs messages through the command prompt
